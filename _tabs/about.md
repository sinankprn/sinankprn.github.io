...
<div class="about-hero">
  <div class="about-hero-body">
    ...
    <ul class="hero-focus" role="list" aria-label="Research focus areas">
      <li><i class="fas fa-futbol" aria-hidden="true"></i> Sport Analytics</li>
      <li><i class="fas fa-robot" aria-hidden="true"></i> Generative AI</li>
      <li><i class="fas fa-flask" aria-hidden="true"></i> LLM Research</li>
    </ul>
  </div>
</div>
