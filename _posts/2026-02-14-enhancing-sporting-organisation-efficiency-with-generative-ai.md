...
This shift has implications for how sporting organisations think about AI investment. Purpose-built tools that solve one narrow problem are harder to justify when a general-purpose model may be able to handle that same problem (and dozens of others) at a fraction of the cost. The value lies less in building tailored models and more in knowing how to use general ones well.
